...
interface IWelcomePageProps {
    auth: { user: any; };
    laravelVersion: string | number | boolean | React.ReactElement<any, string | React.JSXElementConstructor<any>> | React.ReactFragment | React.ReactPortal | null | undefined;
    phpVersion: string | number | boolean | React.ReactElement<any, string | React.JSXElementConstructor<any>> | React.ReactFragment | React.ReactPortal | null | undefined;
}

export default function Welcome(props: IWelcomePageProps) {
    return (
        <>
            <Head title="Welcome"/>
            <div
